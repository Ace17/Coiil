...
static const Resource resources[] =
{
  ...
  { ResourceType::Sound, SND_START, "res/sounds/start.ogg" },
  ...
  { ResourceType::Model, MDL_CRATE, "res/sprites/crate.render" },
  ...
  { ResourceType::Model, MDL_DOOR1, "res/sprites/door1.render" },
  { ResourceType::Model, MDL_DOOR2, "res/sprites/door2.render" },
  { ResourceType::Model, MDL_DOOR3, "res/sprites/door3.render" },
  { ResourceType::Model, MDL_DOOR4, "res/sprites/door4.render" },

  { ResourceType::Model, MDL_SWITCH1, "res/sprites/switch1.render" },
  { ResourceType::Model, MDL_SWITCH2, "res/sprites/switch2.render" },
  { ResourceType::Model, MDL_SWITCH3, "res/sprites/switch3.render" },
  { ResourceType::Model, MDL_SWITCH4, "res/sprites/switch4.render" },
};
